...
public class GetBridgeByRightIdManagerCommand extends AbstractManagerCommand{
    ...
    static {
        CR.update(Code.SERVICE_IS_ABSENCE, "credential:command.get-bridge-by-right-id:service-is-absence");
    }
    ...
    public GetBridgeByRightIdManagerCommand(final Consumer<Result<ManagerDatum>> consumer,
    ...
    protected Result<ManagerDatum> executeService() {
        ...
        Result<List<Bridge>> result = bridgeService.getByRightId(rightId);
        return result.ok()

...
class GetRightByValueManagerCommandTest {
    ...
    void shouldCheckCommandExecution_ifServiceIsAbsence() {
        ...
        new GetRightByValueManagerCommand(consumer, Faker.str_().random()).execute();

        assertThat(okHolder.get()).isFalse();
        assertThat(codeHolder.get()).isEqualTo(CR.get(GetRightByValueManagerCommand.Code.SERVICE_IS_ABSENCE));
    }
    ...
    void shouldCheckCommandExecution_ifEntityIsAbsence() {
        ...
        Supplier<RightService> rightServiceSupplier = () -> {
            ...
            Mockito
                    .when(service.getOneByValue(Mockito.any()))
                    .thenReturn(result);

            return service;
        };

        GetRightByValueManagerCommand command = new GetRightByValueManagerCommand(consumer, Faker.str_().random());
